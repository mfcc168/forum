        ...
        {headerContent || (
          <div className="flex items-start justify-between">
            <div className="flex-1 min-w-0">
              {/* Title */}
              <h3 className="text-lg font-bold text-slate-800 group-hover:text-emerald-600 transition-colors line-clamp-2 mb-2">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-100">
          ...
          {show.tags && item.tags && item.tags.length > 0 ? (
            <TagList 
              tags={item.tags}
              size="sm"
              maxVisible={variant === 'compact' ? 2 : 4}
              enableLinks={false}
            />
          ) : <div />}
